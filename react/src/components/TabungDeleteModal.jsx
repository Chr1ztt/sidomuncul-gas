...
export default function TabungDeleteModal({
	closeDeleteModal,
	handleDelete,
	detail,
}) {
		...
		<Backdrop onClick={(ev) => closeDeleteModal()}>
			...
			>
				...
				<div className="w-full justify-center items-center text-center py-2 text-sm sm:text-md ">
					Peringatan : Anda akan menghapus data tabung dengan nomor berikut ini:
					<span className="block font-bold my-3">{detail.id}</span>
					Apakah Anda yakin?
				</div>
