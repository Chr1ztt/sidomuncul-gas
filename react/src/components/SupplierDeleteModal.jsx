		...
		<Backdrop onClick={(ev) => closeDeleteModal()}>
			...
			>
				...
				<div className="w-full justify-center items-center text-center py-2 text-sm sm:text-md ">
					Peringatan : Anda akan menghapus data supplier berikut ini:
					<span className="block text-forth font-bold my-3">{sup.name}</span>
					Apakah Anda yakin?
				</div>
				...
				<div className="flex w-full flex-row justify-center gap-10 items-center py-2 ">
					...
					<button
						className="flex flex-row justify-center items-center py-2 px-4 w-24  bg-forth text-white hover:opacity-80 rounded-sm"
